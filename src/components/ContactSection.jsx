            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 justify-between">
                        <div className="flex items-start space-x-4">
                            ...
                            <div >
                                ...
                                <a href="mailto:plavazhin@gmail.com"
                    ...
                    <div className="pt-8">
                        ...
                        <div className="flex space-x-4 justify-center">
                            <a href="https://www.linkedin.com/in/nikhilplavazhi/" target="_blank">
                                <Linkedin />
                            </a>
                            <a href="https://www.instagram.com/nikhil_plavazhi/#" target="_blank">
                                <Instagram />
                            </a>
                        </div>
                    </div>
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs">
                    ...
                    <form className="space-y-6">
                        ...
                        <button type="submit" className={classNameFunction(
